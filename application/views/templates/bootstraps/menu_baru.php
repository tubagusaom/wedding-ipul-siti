  ...
  <ul class="nav__list">
    <li class="nav__item">
      <a href="javascript:void(0)" class="nav__link c-primary" menuid-tb="header_top">
        ...
        <img class="menu__imgtb" style="width:40px;" src="<?=base_url()?>_assets/img/demos/wedding/foto/icon_wedding.png" alt="">
    ...
    <!-- <li class="nav__item">
      <a href="javascript:void(0)" class="nav__link c-yellow" menuid-tb="gift">
        <i class="fa fa-gift"></i>
        <span class="c-yellow">Kado</span>
      </a>
    </li> -->
