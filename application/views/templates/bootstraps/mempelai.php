<section id="couple" class="the-wedding-white section section-overlay custom-overlay-1 m-none p-none pb-xlg">
  ...
  <!-- tampilan hp -->
  <div class="vhp bride-groom mt-xlg pt-xlg">
    <!-- <div class=""> -->
      <div class="row mb-xlg">
         ...
         <div class="thumb-bride-groom center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
           ...
           <div class="bride-groom-infos">
             <h2 class="font-weight-normal m-none">
               <font class="text-name-tb text-color-primary">
                 <a href="https://it-https://it-konsultan.com.com" target="_blank" style="text-decoration:none;">Sofi</a>
               </font>
             </h2>

             <!-- <a href="https://it-https://it-konsultan.com.com" target="_blank" style="text-decoration:none;color:#777777">
               {&nbsp;<font class="text-name-tb" style="font-size:13px;">-</font>&nbsp;}
             </a> -->
           ...
           <ul class="social-icons mt-xlg pt-sm">
             ...
             <li class="social-icons-instagram">
               <a href="https://www.instagram.com/sofiaafii_/" target="_blank" title="Instagram">
       ...
       <div class="col-xs-5">
         <div class="thumb-bride-groom center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
           ...
           <div class="bride-groom-infos">
             <h2 class="font-weight-normal m-none">
               <font class="text-name-tb text-color-primary">Bahri</font>
             </h2>
             ...
             <p class="mt-lg tb-quicksand fz-fbx-2">
               Putri Bungsu dari <br>
               Bapak M.fuad <i style="font-size:9px;">( Alm )</i> <br> dan Ibu Saodah
             </p>
           </div>
           ...
           <ul class="social-icons mt-xlg pt-sm">
             ...
             <li class="social-icons-instagram">
               <a href="https://www.instagram.com/sya3ful/" target="_blank" title="Instagram">
                 <i class="fa fa-instagram"></i>
               </a>
             </li>
           </ul>
        ...
        <div class="thumb-bride-groom center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
          ...
          <div class="bride-groom-infos">
            <h2 class="font-weight-normal m-none">
              ...
              <!-- <font class="text-name-tb" style="font-size:16px;"><a href="https://it-https://it-konsultan.com.com" target="_blank" style="text-decoration:none;color:#777777">( Ebe )</a></font> -->
            </h2>
            ...
            <p class="mt-lg tb-quicksand fz-fbx-2">
              ...
              Putri Bungsu dari Bapak Maat <br> dan Ibu Nafsiah
            </p>
          </div>
          <ul class="social-icons mt-xlg pt-sm">
            <!-- <li class="social-icons-facebook">
      ...
      <div class="col-md-4 col-md-offset-2">
        <div class="thumb-bride-groom center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
          ...
          <div class="bride-groom-infos">
            ...
            <p class="mt-lg tb-quicksand fz-fbx-2">
              Putri Bungsu dari Bapak M.fuad <i style="font-size:9px;">( Alm )</i> <br> dan Ibu Saodah
            </p>
          </div>
          <ul class="social-icons mt-xlg pt-sm">
            <!-- <li class="social-icons-facebook">
