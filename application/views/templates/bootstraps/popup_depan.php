...
<audio id="audio1" controls autoplay loop preload controlsList="nodownload" >
  <source src="<?=base_url()?>_assets/audio/ed_Sheeran_perfect.mp3" type="audio/mp3"></source>
</audio>

<!-- <a href="javascript:void(0);" id="tbpopupLink">Klik disini untuk membuka popup</a> -->

<!-- <div id="tbpopupLink"></div> -->
<!-- <div id="tbpopupBox" class="tbpopup animated slideOutUp durationtb" data-appear-animation="slideOutUp" data-appear-animation-delay="0" data-appear-animation-duration="10s"> -->
<div id="tbpopupBox" class="tbpopup">

  <div class="tbpopup-content">

    <!-- <div class="box-content" data-appear-animation="zoomIn" data-appear-animation-delay="0"> -->
      ...
      <section class="jumbotron text-center">
        <div class="font-display">
          ...
          <h4 class="text-name-tb-nobold text-color-primary animated fadeInRight" data-appear-animation="fadeInRight" data-appear-animation-delay="50" style="font-size:30px;">
            <b>Sofi</b> <font>&</font> <b>Bahri</b>
          </h4>
          <p class="pt-1 fw-bolder the-wedding-of-tgl animated fadeInLeft" data-appear-animation="fadeInLeft" data-appear-animation-delay="50">11 Desember 2022</p>
          ...
          <h5 class="tb-quicksand text-color-primary" data-aos="flip-left" data-aos-duration="500" data-aos-delay="50" style="text-shadow: 1px 1px 0 rgb(0 0 0 / 20%);">
            Akhi & Ukhti
          </h5> -->
