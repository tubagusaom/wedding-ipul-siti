<section id="header_top">
  ...
  <div id="bg-tb" class="slidetb">
    ...
    <div class="textbg text-center align-self-center animated rubberBand durationtb3" data-appear-animation="rubberBand" data-appear-animation-delay="0">
      <p class="textbg1 tb-cristtaline">Sofi & Bahri</p>
      <p class="textbg2 tb-quicksand">Pernikahan | Minggu , 11 Desember 2022</p>
    </div>
...
<section class="the-wedding section section-overlay custom-overlay-1 m-none pt-md pb-xlg">
  ...
  <!-- <div class="col-md-12 pt-xlg center"> -->
    <div class="row card_text loading_card zoomIn durationtb2" data-appear-animation="zoomIn" data-appear-animation-delay="0">
