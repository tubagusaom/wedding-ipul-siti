  ...
  <div class="container mt-lg mb-xlg">
    <div class="row">
      <div class="col-md-12 center">
        ...
        <h2 class="text-name-tb-nobold custom-font-size-tb-1" style="font-size:25px!important;">
          <b style="font-size:25px!important;">Sofi</b> <font style="font-size:25px!important;">&</font> <b style="font-size:25px!important;">Bahri</b>
        </h2>

        <!-- <i class="icontb-aomia2 icon-aomia2 text-color-primary"></i> -->
        <!-- <img src="<?=base_url()?>_assets/img/demos/wedding/foto/icon_wedding.png" style="width:150px;" alt=""> -->
      </div>
    </div>
  </div> <br> <br> <br> <br>
</section>
