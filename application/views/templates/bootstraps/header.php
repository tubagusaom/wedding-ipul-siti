...
<html>
	<head>
		...
		<meta name="description" content="Minggu - 11 Desember 2022">
		<meta name="author" content="aom.my.id">


		<!-- Favicon -->
		<link rel="shortcut icon" href="<?=base_url()?>_assets/img/icon-wedding.png" type="image/x-icon" />
		<link rel="apple-touch-icon" href="<?=base_url().'_assets/img/icon-wedding.png'?>">
	...
	<body class="" data-target="#header" data-spy="scroll" data-offset="100">
